public class ESportsEventSinglyLinkedList {

	static GameScore bas;
	static GameScore son;
	int sayac=0;
	...
	public void enQueue(int sayi) { //Add to queue function.
	...
	public static int deQueue() 	
	{
		...
		GameScore temp = bas;
		System.out.printf("The element removed from the queue %d\n", temp.sayi);
		bas = bas.siradaki;
